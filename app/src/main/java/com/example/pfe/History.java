    ...
    public void datte(View v){
        ...
        setListener=new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                Cursor c=dbb.AfficherHistoDep(datee);
                ...
                while(c.moveToNext()) {
                    ...
                    s2.setSpan(new ForegroundColorSpan(Color.RED), 0, s2.length(), flag);
                    ...
                    s4.setSpan(new ForegroundColorSpan(Color.DKGRAY), 0, s4.length(), flag);

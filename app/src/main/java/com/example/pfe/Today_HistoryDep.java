...
public class Today_HistoryDep extends AppCompatActivity {
    db2 db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_today_history_dep);
        h=new MainActivity();
...
//        mouni(this);
    ...
    public  void afficher(){
        ...
        Cursor cursor=db.AfficherHistoDepToday();
    ...
    public void mouni(Context x){
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                redirectActivity(Today_HistoryDep.this,Log.class);
                finish();

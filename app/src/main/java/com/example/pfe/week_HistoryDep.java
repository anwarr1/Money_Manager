...
public class week_HistoryDep extends AppCompatActivity {
    db2 db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week_history_dep);
        h=new MainActivity();
...
//        mouni(this);
    ...
    public  void afficher(){
        ...
        Cursor cursor=db.AfficherHistoDepWeek();
    ...
    public void mouni(Context x){
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                redirectActivity(week_HistoryDep.this,Log.class);
                finish();
